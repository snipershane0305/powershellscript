...
This script changes A LOT so make sure this wont disable anything you need. You may need to set powershells ExecutionPolicy to unrestricted with the `Set-ExecutionPolicy unrestricted` command and maybe add it to your exclusion list in windows defender.
